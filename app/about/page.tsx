...
const values = [
  {
    ...
    description: "Every decision we make is centered around what's best for our clients and their families."
  },
  {
    icon: Shield,
    title: "Trust & Integrity",
    description: "We believe in honest communication and transparent practices in all our relationships."
  },
  {
    icon: Target,
    title: "Personalized Solutions",
    description: "No two families are alike, and neither are their insurance needs. We customize every plan."
  },
  {
    icon: Star,
    title: "Excellence in Service",
    description: "We go above and beyond to deliver exceptional service that exceeds expectations."
  }
]
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <MainContentTransition>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p>
                    Today, we're proud to offer comprehensive coverage options while maintaining the 
                    personal touch that sets us apart. When you call, you'll speak with someone who 
                    knows your name and understands your needs.
                  </p>
                </div>
              </div>
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Why Choose Minarco Insurance?</h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Quick Response Time</h3>
                <p className="text-muted-foreground">Same-day quotes and rapid claim processing. We value your time.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">From auto to life insurance, we protect every aspect of your life.</p>
              </div>
