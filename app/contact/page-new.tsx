        ...
        <section id="contact" className="py-16 sm:py-20 bg-gradient-to-b from-white to-[#edf7f6]/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card className="shadow-xl border-0 bg-gradient-to-br from-white to-[#f98125]/5">
                <CardHeader>
                  <CardTitle className="text-2xl text-foreground flex items-center">
                    <HeadphonesIcon className="h-6 w-6 mr-3 text-primary" />
                    Request a Quote
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <form className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      <Input placeholder="First Name" className="border-input focus:border-[#f98125] focus:ring-[#f98125]" />
                      <Input placeholder="Last Name" className="border-input focus:border-[#f98125] focus:ring-[#f98125]" />
                    </div>
                    <Input type="email" placeholder="Email Address" className="border-input focus:border-[#f98125] focus:ring-[#f98125]" />
                    <Input type="tel" placeholder="Phone Number" className="border-input focus:border-[#f98125] focus:ring-[#f98125]" />
                    <select className="w-full px-4 py-3 border border-input bg-white rounded-md focus:border-[#f98125] focus:ring-2 focus:ring-[#f98125]/20 transition-all">
                    ...
                    <Textarea 
                      ...
                      rows={4} 
                      className="border-input focus:border-[#f98125] focus:ring-[#f98125] resize-none" 
                    />
                    <Button
                      type="submit"
